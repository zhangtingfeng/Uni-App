...
namespace DTcms.BLL
{
    ...
    public partial class article
    {
        ...
        public Model.article   GetPreModel(int channel_id,int category_id,int id)
        {
            var channel_name = new site_channel().GetChannelName(channel_id);
            return dal.GetNextModel(channel_name, category_id,id);
        }
        public Model.article GetNextModel (int channel_id, int category_id, int id)
        {
            var channel_name = new site_channel().GetChannelName(channel_id);
            return dal.GetPreModel(channel_name, category_id, id);
        }
        /// <summary>
        /// 得到一个对象实体
        /// </summary>
        ...
        public Model.article GetTop1Model(int channel_id, int category_id)
        {
            string channelName = new BLL.site_channel().GetChannelName(channel_id);//查询频道名称
            if (string.IsNullOrEmpty(channelName))
            {
            ...
            return dal.GetTop1Model(channelName, category_id);
        }
        /// <summary>
        /// 获得前几行数据
        /// </summary>
        ...
        public List<Model.article> GetListAsync(int channel_id, int Top, string strWhere, string filedOrder)
        {
            string channelName = new BLL.site_channel().GetChannelName(channel_id);//查询频道名称
            if (string.IsNullOrEmpty(channelName))
            {
            ...
            return dal.GetListAsync(channelName, Top, strWhere, filedOrder);
        }
        /// <summary>
        /// 获得查询分页数据
        /// </summary>
        ...
        public List<Model.article> GetListAsync(int channel_id, int category_id, int pageSize, int pageIndex, string strWhere, string filedOrder, out int recordCount)
        {
            string channelName = new BLL.site_channel().GetChannelName(channel_id);//查询频道名称
            if (string.IsNullOrEmpty(channelName))
            {
            ...
            return dal.GetListAsync(channelName, category_id, pageSize, pageIndex, strWhere, filedOrder, out recordCount);
        }
        #endregion
